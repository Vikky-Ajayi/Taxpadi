...
export default function TransactionsPage() {
  ...
  const { data: transactions, isLoading: isLoadingTransactions } = useListTransactions(
    ...
    { query: { queryKey: getListTransactionsQueryKey({ statementId: selectedStatementId || undefined, category: categoryFilter !== "all" ? categoryFilter : undefined }), enabled: !!selectedStatementId } }
  );

  const { data: summary, isLoading: isLoadingSummary } = useGetTransactionSummary(
    { statementId: selectedStatementId! },
    { query: { queryKey: getGetTransactionSummaryQueryKey({ statementId: selectedStatementId! }), enabled: !!selectedStatementId } }
  );
